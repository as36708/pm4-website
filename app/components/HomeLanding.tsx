        ...
        <div className={styles.modalBackdrop} role="presentation" onMouseDown={(event) => { if (event.currentTarget === event.target) closeExchange(); }}>
          <div className={styles.modal} ref={dialogRef} role="dialog" aria-modal="true" aria-labelledby="exchange-modal-title">
            ...
            <div className={styles.modalOptions}>
              ...
              {selectedExchange.id === "okx" ? <a href="/transfer-okx" onClick={closeExchange} data-pm4-event="transfer_click" data-pm4-exchange={selectedExchange.name}>
              ...
              </Link> : <a href={EXTERNAL_LINKS.discordInvite} target="_blank" rel="noopener noreferrer" onClick={closeExchange} data-pm4-event="transfer_click" data-pm4-exchange={selectedExchange.name}>
