...
export default function PrivacyPage() {
  return (
    <main id="main-content" className="legal-page">
      ...
      <h1>隐私政策</h1>
      <p className="legal-updated">更新日期：2026 年 8 月 28 日</p>
      <section><h2>我们收集什么</h2><p>当你提交指标审核资料时，我们会收集所选交易所、交易所 UID、TradingView 用户名和 Discord 用户名。Discord 用户名是审核必填项，仅用于身份核对和审核通知。请不要提交密码、验证码、API 密钥、助记词或身份证件。</p></section>
      ...
      <section><h2>同意记录</h2><p>提交审核资料时，我们会记录你是否同意隐私政策与服务条款、同意时间以及当时适用的政策版本，用于确认授权状态和处理相关查询。</p></section>
      <section><h2>用途、共享与保留</h2><p>资料仅用于核对返佣资格、处理 TradingView 指标权限、身份核对、发送审核通知和防止重复或滥用提交；Discord 用户名不会用于审核以外的用途。必要信息会发送至 PM4 管理后台；交易所及 Discord/Telegram 适用其各自的隐私政策。审核记录原则上在业务关系存续期间保留，停止使用后会按运营、争议处理和合规需要定期清理。</p></section>
